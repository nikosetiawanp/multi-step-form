      ...
      <div className="flex flex-col gap-6 w-full md:max-w-[350px] lg:max-w-[450px]">
        ...
        <div className="flex flex-col gap-2 md:gap-4">
          {addons.map((addon: Addon) => (
            <div
              key={addon.id}
              className="flex items-center p-4 md:px-6 md:py-4 gap-4 md:gap-6 border bg-blue-50 border-purple-600 rounded-lg hover:cursor-pointer"
            >
              {/* Checkbox */}
              <div className="min-w-[20px] min-h-[20px] flex justify-center items-center bg-purple-600 rounded-sm">
